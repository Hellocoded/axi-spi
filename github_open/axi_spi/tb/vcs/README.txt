...
#
# Generated by export_simulation on Sun Apr 16 10:49:14 CST 2023
#
################################################################################
...
'-reset_run' switch to the './axi_spi_test_transfer.sh' script.

./axi_spi_test_transfer.sh -reset_run
...
./axi_spi_test_transfer.sh -noclean_files

For more information on the script, please type './axi_spi_test_transfer.sh -help'.
